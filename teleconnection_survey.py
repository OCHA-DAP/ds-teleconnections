...
_GREY_NE, _GREY_NE_E = "#DBDBDB", "#BDBDBD"    # searched, no documented effect
_GREY_NS, _GREY_NS_E = "#FCFCFC", "#DCDCDC"    # not searched (near-white, fine outline)

# All countries covered by the literature review (the humanitarian-priority
# regions). Searched countries without a documented link (e.g. JOR/BGD/LKA) are
# drawn light grey; countries outside this set are "not searched" (near-white).
_LIT_SEARCHED = {
    "ETH", "SOM", "KEN", "DJI", "ERI", "SSD", "SDN",                       # Horn
    "SEN", "MLI", "NER", "TCD", "BFA", "NGA", "MRT", "GMB", "GNB", "GIN",  # Sahel/W Africa
    "YEM", "SAU", "OMN", "IRQ", "IRN", "SYR", "JOR", "ARE",                # Middle East/Arabia
    "IND", "PAK", "BGD", "LKA", "AFG", "NPL",                             # South Asia
    "GTM", "HND", "SLV", "NIC", "CRI", "PAN",                            # Central America
    "ZWE", "ZMB", "MWI", "MOZ", "ZAF", "BWA", "NAM", "AGO", "LSO",        # Southern Africa
    "IDN", "PHL", "VNM", "THA", "KHM", "LAO", "MMR", "MYS",               # SE Asia
}
...
{"".join(index_sections)}
  ...
  <section>
    ...
    <p class="enso-note" style="margin:0.2rem auto 0.9rem;max-width:1140px;font-size:0.73rem;color:#666;">
      ...
      (e.g. OND, JJAS, DJF) label each signal. <strong>Grey</strong> countries fall within the reviewed
      regions but had no robust documented ENSO rainfall link; <strong>near-white</strong> countries were
      outside the regions covered by this review. See the table below for sources and evidence strength.
    </p>
