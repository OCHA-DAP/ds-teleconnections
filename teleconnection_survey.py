...
_BLUE, _BLUE_E = "#9AC6EA", "#6FA8D6"    # wetter (pale)
_BROWN, _BROWN_E = "#D7A87C", "#BE8A5C"  # drier (pale)
...
{"".join(index_sections)}
  ...
  <section>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:0.4rem 1.1rem;font-size:0.72rem;color:#444;margin:0.5rem 0 0.2rem;"><span><span style="display:inline-block;width:0.9em;height:0.9em;border-radius:2px;vertical-align:middle;margin-right:0.3em;background:#D7A87C;border:1px solid #BE8A5C;"></span>drier</span><span><span style="display:inline-block;width:0.9em;height:0.9em;border-radius:2px;vertical-align:middle;margin-right:0.3em;background:#9AC6EA;border:1px solid #6FA8D6;"></span>wetter</span><span><span style="display:inline-block;width:0.9em;height:0.9em;border-radius:2px;vertical-align:middle;margin-right:0.3em;background:linear-gradient(135deg,#9AC6EA 50%,#D7A87C 50%);border:1px solid #777;"></span>Opposing signals by season (e.g. Ethiopia, Yemen)</span><span><span style="display:inline-block;width:0.9em;height:0.9em;border-radius:2px;vertical-align:middle;margin-right:0.3em;background:#F4F4F4;border:1px solid #C8C8C8;"></span>Not in this catalogue</span></div>
    <p class="enso-note" style="margin:0.2rem auto 0.9rem;max-width:1140px;font-size:0.73rem;color:#666;">
      Ethiopia and Yemen are split because their seasons respond in opposite directions; 3-month season codes
      (e.g. OND, JJAS, DJF) label each signal. See the table below for sources and evidence strength.
    </p>
<div style="overflow-x:auto;"><table style="border-collapse:collapse;width:100%;font-size:0.78rem;line-height:1.4;min-width:760px;"><thead><tr><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">Region / area</th><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">Season</th><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">El&nbsp;Niño</th><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">La&nbsp;Niña</th><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">Evidence &amp; source</th><th style="text-align:left;padding:0.35rem 0.5rem;border-bottom:2px solid #c4cdda;font-weight:600;color:#1a1a1a;background:#eef2f7;">This study (ERA5)</th></tr></thead><tbody><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Horn of Africa</span><br><span style="color:#222;">Kenya, S. Somalia, SE Ethiopia</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">OND “short rains”</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Robust, widely replicated<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2020JD033121" target="_blank" rel="noopener" style="color:#2563b8;">Park et&nbsp;al. 2020 (JGR-A)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — SOM OND r=+0.65, KEN +0.58, ETH +0.59</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Horn of Africa</span><br><span style="color:#222;">Ethiopia / Sudan / S. Sudan highlands</span> <span style="background:#7B3A1A;color:#fff;font-size:0.62rem;padding:0.05rem 0.3rem;border-radius:3px;white-space:nowrap;">gap vs NOAA/IRI</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJAS (kiremt / Blue Nile)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Robust<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/10.1029/1999GL011140" target="_blank" rel="noopener" style="color:#2563b8;">Dai &amp; Wigley 2000 (GRL)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — ETH JAS r=−0.63, SSD −0.59, SDN −0.40</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Horn of Africa</span><br><span style="color:#222;">East Africa</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">MAM “long rains”</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#E8E8E8;text-align:center;color:#555;">weak / none</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#E8E8E8;text-align:center;color:#555;">weak / none</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Long rains only weakly tied to ENSO<br><a href="https://link.springer.com/article/10.1007/s00382-018-4239-7" target="_blank" rel="noopener" style="color:#2563b8;">Wainwright et&nbsp;al. 2018 (Clim&nbsp;Dyn)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — little MAM ENSO signal in the Horn</td></tr><tr style="background:#ffffff;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Sahel &amp; W. Africa</span><br><span style="color:#222;">Senegal, Mali, Niger, Chad, N. Nigeria</span> <span style="background:#7B3A1A;color:#fff;font-size:0.62rem;padding:0.05rem 0.3rem;border-radius:3px;white-space:nowrap;">gap vs NOAA/IRI</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJAS monsoon</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Direction robust; mechanism contested<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/10.1029/1999GL011140" target="_blank" rel="noopener" style="color:#2563b8;">Dai &amp; Wigley 2000 (GRL)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — SEN JJA −0.49, MLI JAS −0.41, TCD −0.43</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Middle East / Arabia</span><br><span style="color:#222;">SW Arabia / highland Yemen</span> <span style="background:#7B3A1A;color:#fff;font-size:0.62rem;padding:0.05rem 0.3rem;border-radius:3px;white-space:nowrap;">gap vs NOAA/IRI</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJA summer rains</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier (drought)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Single robust modelling+obs study; <strong>direct</strong> Pacific teleconnection<br><a href="https://www.nature.com/articles/s41612-017-0003-7" target="_blank" rel="noopener" style="color:#2563b8;">Atif et&nbsp;al. 2017 (npj&nbsp;Clim&nbsp;Atmos&nbsp;Sci)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — YEM JAS r=−0.59 (summer); winter NDJ +0.53</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Middle East / Arabia</span><br><span style="color:#222;">Iraq, Iran, Levant, N. Arabia</span> <span style="background:#7B3A1A;color:#fff;font-size:0.62rem;padding:0.05rem 0.3rem;border-radius:3px;white-space:nowrap;">gap vs NOAA/IRI</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">SON–DJF autumn–winter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Multiple studies; autumn phase-transition evidence<br><a href="https://www.researchgate.net/publication/337134434_The_Impact_of_ENSO_Phase_Transition_on_the_Atmospheric_Circulation_Precipitation_and_Temperature_in_the_Middle_East_Autumn" target="_blank" rel="noopener" style="color:#2563b8;">Middle East autumn–ENSO study 2019</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — IRQ SON +0.63, IRN OND +0.59, SAU MAM +0.51</td></tr><tr style="background:#ffffff;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">South Asia</span><br><span style="color:#222;">India (all-India monsoon)</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJAS</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Robust historically but <strong>non-stationary</strong> (weakened since ~1980s)<br><a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8605027/" target="_blank" rel="noopener" style="color:#2563b8;">Indian-monsoon non-stationarity reviews</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Weak in ERA5 — all-India JJAS not significant (consistent with the documented weakening)</td></tr><tr style="background:#ffffff;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">South Asia</span><br><span style="color:#222;">Pakistan, Afghanistan</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">OND &amp; MAM (winter–spring)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Established<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/10.1029/1999GL011140" target="_blank" rel="noopener" style="color:#2563b8;">Dai &amp; Wigley 2000 (GRL)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — PAK OND +0.55, MAM +0.54; AFG AMJ +0.59</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Central America</span><br><span style="color:#222;">Guatemala, Honduras, El&nbsp;Salvador, Nicaragua (Dry Corridor)</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJA–SON (incl. canícula)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier (drought)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Canonical<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/10.1029/1999GL011140" target="_blank" rel="noopener" style="color:#2563b8;">Dai &amp; Wigley 2000 (GRL)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — GTM ASO −0.61, HND −0.60, NIC −0.61</td></tr><tr style="background:#ffffff;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">Southern Africa</span><br><span style="color:#222;">Zimbabwe, Zambia, Malawi, Mozambique, S.&nbsp;Africa, Botswana</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">DJF austral summer</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier (drought)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Robust, widely replicated<br><a href="https://journals.ametsoc.org/view/journals/bams/82/4/1520-0477_2001_082_0619_ppaawe_2_3_co_2.xml" target="_blank" rel="noopener" style="color:#2563b8;">Mason &amp; Goddard 2001 (BAMS)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees — ZWE DJF −0.68, ZAF NDJ −0.62, MOZ JFM −0.50</td></tr><tr style="background:#f7f9fc;"><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;"><span style="color:#5a6b85;">SE Asia / Maritime Continent</span><br><span style="color:#222;">Indonesia, Philippines, Vietnam, Thailand</span></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">JJA–SON dry season</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#D7A87C;border-right:1px solid #BE8A5C;text-align:center;color:#3a1a06;">drier (drought)</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;background:#9AC6EA;border-right:1px solid #6FA8D6;text-align:center;color:#08306b;">wetter</td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Very robust (drought &amp; fire risk)<br><a href="https://agupubs.onlinelibrary.wiley.com/doi/10.1029/1999GL011140" target="_blank" rel="noopener" style="color:#2563b8;">Dai &amp; Wigley 2000 (GRL)</a></td><td style="padding:0.35rem 0.5rem;border-bottom:1px solid #e3e8ef;vertical-align:top;">Agrees strongly — IDN ASO −0.87, PHL FMA −0.86, THA −0.81</td></tr></tbody></table></div>
  ...
  <section>
    ...
    <div class="note" style="font-size:0.82rem;line-height:1.6;">
      ...
      <p style="margin:0 0 0.6rem;">
        ...
        it is reported as a <em>direct</em> Pacific teleconnection (Atif et&nbsp;al. 2017).
      </p>
      <p style="margin:0 0 0.6rem;">
      ...
      <p style="margin:0 0 0.6rem;">
        The map colors each country by the dominant documented <strong>El&nbsp;Niño</strong> response in its main
        humanitarian rainy season, labelled with the relevant 3-month season; countries whose seasons respond in
        opposite directions (Ethiopia, Yemen) are shown split. The <strong>La&nbsp;Niña</strong> map is the
        mechanical inverse of the El&nbsp;Niño map — a first-order picture only, since ENSO is asymmetric and a
        true La&nbsp;Niña composite is not simply the opposite of El&nbsp;Niño. The selection of regions
        (humanitarian-priority) and the “gap vs NOAA/IRI” judgements are deliberate editorial choices, and
        literature coverage is uneven between regions.
      </p>
