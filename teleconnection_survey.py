...
{"".join(index_sections)}
  ...
  <section>
    ...
    <div class="note" style="font-size:0.82rem;line-height:1.6;">
      ...
      <p style="margin:0 0 0.6rem;">
        Seasons are non-overlapping standard trimester windows: DJF (Dec–Feb), MAM (Mar–May), JAS (Jul–Sep),
        OND (Oct–Dec). DJF is labeled by the December year (e.g. DJF 2024 = Dec 2024–Feb 2025).
        Only trimesters representing a genuine rainy season are analyzed: a country–trimester pair is included
        only if that trimester's climatological mean rainfall is at least 25% of the country's annual total
        (climatolocial mean over the full period). This suppresses spurious correlations in dry seasons.
      </p>
      ...
      <p style="margin:0 0 0.6rem;">
        ...
        Only the rainy-season trimester with the strongest best-lag correlation is shown per country–index pair.
      ...
      <p style="margin:0 0 0.6rem;">
        ...
        the residuals is taken as the partial correlation. PDO is included as a control variable but not
        used as a target index in partial regressions, since its global footprint is harder to separate from
        ENSO at interannual timescales. Best lags are identical to those from the total pass.
      </p>
      <p style="margin:0 0 0.6rem;">
